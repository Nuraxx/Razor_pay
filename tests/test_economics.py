...
class TestEvaluationIntegration:
    ...
    def test_summarize_economics_reads_existing_realized_totals(self):
        ...
        # MULTI-ATTEMPT PERSISTENCE / APPLES-TO-APPLES FIX: improved_fallback_policy
        # and oracle_policy are costed the same n_attempts-based way as
        # fixed_retry -- see summarize_economics.
        events["improved_fallback_policy__n_attempts"] = [1, 1, 0]
        events["oracle_policy__n_attempts"] = [1, 1, 0]
